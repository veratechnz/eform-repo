...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarToggler = function () {
        ...
        $('.page-header .quick-sidebar-toggler, .page-quick-sidebar-toggler, .new-trigger').click(function (e) {

            $('body').toggleClass('page-quick-sidebar-open');

            //See Custom js. Moves the side tab trigger (Added By Jared 13-08-15)
            if ($('#sliderTab').hasClass('movement')) {
                return;
            } else {
            sideTriggerSlide();
            }

            //Enable Trigger Slide
            function sideTriggerSlide() {
                $('#slider-tab').toggleClass('movement');
                return;
            }

        });

    }; //var handleQuickSidebarToggler Ends
